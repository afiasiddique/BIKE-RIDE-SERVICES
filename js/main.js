(function($) {
   ...
   /* ================================
    ...
    document.querySelectorAll('input[type="color"][data-var]').forEach((picker) => {
        picker.addEventListener('input', function () {
          const targetVar = this.getAttribute('data-var');
          const selectedColor = this.value;
      
          if (targetVar) {
            document.documentElement.style.setProperty(targetVar, selectedColor);
          }
        });
    });
   ...
   /* ================================
    ...
    function initPreloader() {
        ...
        // Animate bike after 0.3s
        setTimeout(() => {
        if (bike) bike.classList.add('animate');
        }, 300);

        // Hide preloader and show main content after 2s
        setTimeout(() => {
    ...
    // Run after small delay to ensure elements exist
    setTimeout(initPreloader, 10);
